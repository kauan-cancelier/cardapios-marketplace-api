...
public class RestauranteController {
	...
	public ResponseEntity<?> inserir(
		...
		Preconditions.checkArgument(!restaurante.isPersistido(), "O restaurante já foi criado anteriormente. ");
	...
	public ResponseEntity<?> buscarPor(@PathVariable("id") Integer id) {
		Restaurante restauranteEncontrado = restauranteService.buscarPor(id);
